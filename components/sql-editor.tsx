...
function defineSqlLabDarkTheme(monaco: { editor: { defineTheme: (name: string, data: unknown) => void } }) {
  monaco.editor.defineTheme(EDITOR_THEME_DARK, {
    ...
    rules: [
      ...
      { token: "comment.sql",       foreground: "6b737c", fontStyle: "italic" },
...
function defineSqlLabLightTheme(monaco: { editor: { defineTheme: (name: string, data: unknown) => void } }) {
  monaco.editor.defineTheme(EDITOR_THEME_LIGHT, {
    ...
    inherit: true,
    rules: [
      // Same hues as dark theme, darkened/saturated for light background
      { token: "keyword",           foreground: "0070c1" },          // dark blue  (dark: 569cd6)
      { token: "keyword.sql",       foreground: "0070c1" },
      { token: "operator.sql",      foreground: "0070c1" },
      { token: "string",            foreground: "b84400" },          // dark orange (dark: ce9178)
      { token: "string.sql",        foreground: "b84400" },
      { token: "string.escape.sql", foreground: "9a6b00" },          // dark gold   (dark: d7ba7d)
      { token: "comment",           foreground: "868686", fontStyle: "italic" }, // gray
      { token: "comment.sql",       foreground: "868686", fontStyle: "italic" },
      { token: "number",            foreground: "4a7c38" },          // deep green  (dark: b5cea8)
      { token: "number.sql",        foreground: "4a7c38" },
      { token: "predefined",        foreground: "0d7560" },          // dark teal   (dark: 4ec9b0)
      { token: "predefined.sql",    foreground: "0d7560" },
      { token: "type",              foreground: "0d7560" },
      { token: "delimiter",         foreground: "5f5f5f" },          // mid gray    (dark: 808080)
      { token: "identifier",        foreground: "1e1e1e" },          // near black  (dark: d4d4d4)
    ],
    colors: {
      ...
      "editor.selectionBackground": "#d4e5fd",
      ...
      "editorSuggestWidget.selectedBackground": "#d4e5fd",
    },
  });
}
